...
pub(crate) type SessionIdGenerator = Arc<dyn Fn(&[u8]) -> [u8; 32] + Send + Sync>;
...
pub(super) struct ClientHelloInput {
    ...
    pub(super) use_session_id_generator: bool,
    pub(super) session_id_generator: Option<SessionIdGenerator>,
}
...
impl ClientHelloInput {
    pub(super) fn new(
        ...
        Ok(Self {
            ...
            server_name,
            prev_ech_ext: None,
            use_session_id_generator: session_id_generator.is_some(),
